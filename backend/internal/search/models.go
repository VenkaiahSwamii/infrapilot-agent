...
// FacetCount represents facet metadata
type FacetCount struct {
	Value string `json:"value"`
	Count int64  `json:"count"`
}

// SearchResponse represents structured search output
...
// PopularSearch represents aggregated popular searches
type PopularSearch struct {
	Query       string `json:"query"`
	SearchCount int    `json:"search_count"`
}

// AISearchRequest represents natural language search request
type AISearchRequest struct {
	Query string `json:"query" binding:"required"`
}

// AISearchResponse represents natural language search result
